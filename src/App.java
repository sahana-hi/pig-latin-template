public class App {
    public static void main(String[] args)
    {
        ...
        input.printlines(150,3);
        Book output = PigLatinTranslator.translate(input);
        output.printlines(150,3);
        output.writeToFile();

        // book of my choosing Merchant of venice : 
        input.readFromUrl("Merchant of Venice", "https://www.gutenberg.org/cache/epub/1515/pg1515-images.html");
        input.printlines(150,3);
